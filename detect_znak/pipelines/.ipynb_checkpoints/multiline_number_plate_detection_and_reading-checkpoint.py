...
Examples:
    ...
    >>> result = multiline_number_plate_detection_and_reading(glob(os.path.join(detect_znak_dir, './data/examples/multiline_images/*')))
...
from detect_znak.pipes.number_plate_multiline_extractors.multiline_np_extractor \
