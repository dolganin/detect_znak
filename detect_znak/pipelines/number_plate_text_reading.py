...
class NumberPlateTextReading(Pipeline):
    ...
    def __init__(self,
        ...
        deploy_cfg = "../../../mmdeploy/configs/mmocr/text-recognition/text-recognition_onnxruntime_static.py"
        self.deploy_cfg = deploy_cfg
        model_cfg = "../../../mmocr/configs/textrecog/abinet/abinet256x64.py"
        self.model_cfg = model_cfg
        self.device = 'cpu'
        backend_model = "../../../mmdeploy/mmdeploy_models/mmocr/abinet/ort/end2end.onnx"
