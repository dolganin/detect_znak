...
from detect_znak.tools import promise_all
from detect_znak.tools import chunked_iterable
from detect_znak.image_loaders import BaseImageLoader, DumpyImageLoader, image_loaders_map
...
#                     print("[INFO] image_points", image_points)
                ...
                if matplotlib_show:
                    ...
                    # Calculate the size of the square and rectangle
                    check_color = (0, 255, 0)
...
#                     print(rectangle_width * rectangle_height)
                    # Draw a square's number plate
                    cv2.rectangle(image, (0, 0), (square_width, square_height), check_color, 1)  # Green square
                    # Draw a rectangle
                    cv2.rectangle(image, (0, 0), (rectangle_width, rectangle_height), check_color, 1)  # Red rectangle
