...
from detect_znak.data_modules.numberplate_orientation_data_module import OrientationDataModule, show_data
from detect_znak.nnmodels.numberplate_orientation_model import NPOrientationNet
