...
from detect_znak.data_modules.numberplate_inverse_data_module import InverseNetDataModule
from detect_znak.nnmodels.numberplate_inverse_model import NPInverseNet
