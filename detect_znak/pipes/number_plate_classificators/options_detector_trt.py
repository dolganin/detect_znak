"""
python3 -m detect_znak.pipes.number_plate_classificators.options_detector_trt \
        -f detect_znak/pipes/number_plate_classificators/options_detector_trt.py
"""
import os
import cv2
...
from detect_znak.tools import modelhub
