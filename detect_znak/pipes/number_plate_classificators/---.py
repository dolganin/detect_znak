...
from detect_znak.data_modules.numberplate_options_data_module import OptionsNetDataModule
from detect_znak.nnmodels.numberplate_options_model import NPOptionsNet
from detect_znak.tools.image_processing import normalize_img, convert_cv_zones_rgb_to_bgr
...
#         self.model = self.model.to(device_torch)
#         self.model.eval()
        self.model = onnxruntime.InferenceSession("/workspace/test/nomeroff-net/data/models/OptionsDetector/numberplate_options/classifier.onnx", providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
        return self.model
