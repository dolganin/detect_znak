...
#         self.model = self.model.to(device_torch)
#         self.model.eval()
        self.model = onnxruntime.InferenceSession("/workspace/test/detect_znak/data/models/OptionsDetector/numberplate_options/classifier.onnx", providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
        return self.model
