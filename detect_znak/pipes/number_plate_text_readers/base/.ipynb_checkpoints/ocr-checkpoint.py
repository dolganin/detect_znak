"""
python3 -m detect_znak.text_detectors.base.ocr -f detect_znak/text_detectors/base/ocr.py
"""
import os
import cv2
import json
...
from detect_znak.data_modules.numberplate_ocr_data_module import OcrNetDataModule
from detect_znak.nnmodels.ocr_model import NPOcrNet, weights_init

from detect_znak.tools.image_processing import normalize_img
from detect_znak.tools.errors import OCRError
from detect_znak.tools.mcm import modelhub, get_device_torch
from detect_znak.tools.augmentations import aug_seed
from detect_znak.tools.ocr_tools import (StrLabelConverter,
                                          decode_prediction,
                                          decode_batch)
