...
from detect_znak.tools.mcm import modelhub
from detect_znak.tools.errors import TextDetectorError
from detect_znak.tools.image_processing import convert_cv_zones_rgb_to_bgr
...
class TextDetector(object):
    ...
    def load(self):
        ...
        """
        self.detectors = []
        self.detectors.append(MMOCRInferencer)
        """
        pass
