...
def read_version():
    ...
    with open(os.path.join(__PATH__, 'detect_znak/__init__.py')) as f:
...
setup(name='detect_znak',
      ...
      keywords='detect_znak',
      url='https://github.com/dolganin/detect_znak',
      author='Phedotov Dmitriy, Sergey Dolganin, Anton Pimonov, Vasiliy Babishkin, Denis Milaev',
      author_email='d.fedotov@g.nsu.ru',
