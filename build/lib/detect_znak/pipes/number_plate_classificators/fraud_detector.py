...
from detect_znak.data_modules.numberplate_fraud_data_module import FraudNetDataModule
from detect_znak.nnmodels.fraud_numberpate_model import FraudNPNet
